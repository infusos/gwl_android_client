...
import com.girlswearingleather.app.fragment.GirlFragment;
import com.girlswearingleather.app.fragment.NavigationDrawerFragment;
import com.nostra13.universalimageloader.core.ImageLoader;
import com.nostra13.universalimageloader.core.ImageLoaderConfiguration;

public class MainActivity extends AppCompatActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks, GirlFragment.OnFragmentInteractionListener {
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position){
            case 0:
                ...
                break;
            case 1:
                fragmentManager.beginTransaction().replace(R.id.container, GirlFragment.newInstance("","")).commit();
                break;
            case 2:
